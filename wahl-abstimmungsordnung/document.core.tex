\stupadate{15.04.2014}
\publishdate{02.05.2014}
\jurchanges{
...
\begin{jurdoc}[Wahl- und Abstimmungsordnung]{Wahl- und Abstimmungsordnung\\der Verfassten Studierendenschaft\\des Karlsruher Instituts für Technologie (KIT)}

\jurparagraph{Geltungsbereich}\label{wahl:geltungsbereich}
...
\jurparagraph{Wahlsystem}\label{wahl:wahlsystem}
...
\jurparagraph{Urabstimmung}\label{wahl:urabstimmung}
...
\jurparagraph{Wahlberechtigung und Wählbarkeit}\label{wahl:wahlberechtigung}

Wahlberechtigt sind alle Mitglieder, die im Wählerinnenverzeichnis eingetragen sind.
...
\jurparagraph{Wahltermin}\label{wahl:walhtermin}
Die Wahlen sollen jährlich im Sommersemester parallel zur Wahl der studentischen Senatsmitglieder des KIT stattfinden.

Das Studierendenparlament legt Termin und Dauer der Wahlen gemäß §~40 Absatz~5 Organisationssatzung fest. Der Wahlzeitraum besteht aus wenigstens drei und höchstens fünf aufeinanderfolgenden Tagen. Die Wahlen dürfen nicht in den ersten drei Vorlesungswochen oder in der letzten Vorlesungswoche des Semesters stattfinden.

In der Regel finden die Wahlen zum Studierendenparlament und den Fachschaftsvorständen zeitgleich statt.

\jurparagraph{Wahlausschuss}\label{wahl:wahlausschuss}
...
\begin{enumerate}
    ...
    \item Erstellung des Wählerinnenverzeichnisses,
...
\jurparagraph{Bekanntmachung der Wahlen}\label{wahl:bekanntmachung-wahl}
Der Wahlausschuss macht die Wahl spätestens 42 Tage vor dem ersten Wahltag gemäß §~40 Absatz~3 Organisationssatzung bekannt.

Die Bekanntmachung enthält:
\begin{enumerate}
     \item den Wahlzeitraum sowie die Abstimmungszeiten,
     \item den Hinweis, dass nur wählen darf, wer am Tag des endgültigen Abschlusses des Wählerinnenverzeichnises in diesem eingetragen ist,
     \item Ort, Dauer und Zeit der Einsichtsmöglichkeit in das Wählerinnenverzeichnisses,
     \item die zu wählenden Gremien sowie die Zahl der jeweils zu wählenden Mitglieder und deren Amtszeit,
     \item die Aufforderung, spätestens am 24. Tag vor dem ersten Wahltag Wahlvorschläge beim Wahlausschuss einzureichen,
     \item <gestrichen>
...
\jurparagraph{Bekanntmachung der Urabstimmung}\label{wahl:bekanntmachung-ua}
...
\jurparagraph{Wählerinnenverzeichnis}\label{wahl:waehlerinnenverzeichnis}

Alle Wahlberechtigten gemäß §~3 Absatz~2 Organisationssatzung sind in ein Wählerinnenverzeichnis in Listenform einzutragen. Die Aufstellung des Wählerinnenverzeichnisses obliegt dem  Wahlausschuss. Es kann im Wahlverfahren auch in elektronischer Form  verwendet werden.

Das Wählerinnenverzeichnis enthält die folgenden Angaben:
\begin{enumerate}
\item laufende Nummer,
\item Familienname,
\item Vorname,
\item Matrikelnummer,
\item Fakultätszugehörigkeit,
\item Vermerk über die Stimmabgabe,
\item Bemerkungen.
\end{enumerate}

Das Wählerinnenverzeichnis ist sieben Tage nach Bekanntmachung der Wahl bzw. Urabstimmung vorläufig  abzuschließen und für fünf Tage beim Wahlausschuss zur Einsicht durch die Studierenden aufzulegen. Eine Einsichtnahme steht jedem zu, um seine  eigenen Daten auf Richtigkeit und Vollständigkeit zu überprüfen. Zur Überprüfung der Richtigkeit oder Vollständigkeit der Daten von anderen im Wählerinnenverzeichnis eingetragenen Personen haben Wahlberechtigte nur dann ein Recht auf Einsicht in das Wählerinnenverzeichnis, wenn sie Tatsachen glaubhaft machen, aus denen sich eine Unrichtigkeit oder Unvollständigkeit des Wählerinnenverzeichnisses ergeben kann.  \label{wahl:waehlerinnenverzeichnis:auflegung}

Das Wählerinnenverzeichnis ist spätestens am 14. Tag nach Bekanntmachung der Wahl bzw. Urabstimmung  unter Berücksichtigung der Entscheidungen nach  \ref{wahl:aenderungwv:aenderungen} vom Wahlausschuss endgültig  abzuschließen. Dabei ist im Wählerinnenverzeichnis
\begin{enumerate}
\item die Zahl der eingetragenen Wahlberechtigten,
\item die Zahl der Anträge auf Berichtigung des Wählerinnenverzeichnisses
\end{enumerate}
vom Wahlausschuss zu beurkunden.

\jurparagraph{Änderung des Wählerinnenverzeichnisses}
Die Einsichtsberechtigten gemäß \ref{wahl:waehlerinnenverzeichnis:auflegung} können während der Dauer der Auflegung des Wählerinnenverzeichnisses dessen Berichtigung oder Ergänzung beantragen, wenn sie diese für unrichtig oder unvollständig halten. Der Antrag ist schriftlich beim Wahlausschuss zu stellen. Die erforderlichen Beweise sind vom Antragsteller beizubringen. Der Wahlausschuss entscheidet spätestens am 14. Tag nach Bekanntmachung der Wahl bzw. Urabstimmung über die Anträge. Die Entscheidung ist der Antragstellerin und ggf. der Betroffenen mitzuteilen.\label{wahl:aenderungwv:aenderungen}

Das Wählerinnenverzeichnis kann vom Wahlausschuss bei Vorliegen offensichtlicher Fehler, Unstimmigkeiten oder Schreibversehen berichtigt oder ergänzt werden.

Änderungen sind als solche kenntlich zu machen und mit Datum und Unterschrift zu versehen.

\jurparagraph{Wahlvorschläge}\label{wahl:wahlvorschlaege}
...
Geben die Kennwörter mehrerer Wahlvorschläge zu Verwechslungen Anlass, so fordert der Wahlausschuss die Vertreterin des später eingereichten Wahlvorschlages unverzüglich auf, sich innerhalb der Mängelbeseitigungsfrist gemäß \ref{wahl:wahlvorschlaege:maengel} ein anderes Kennwort zu geben.

Der Wahlvorschlag für einen Fachschaftsvorstand muss enthalten:
\begin{enumerate}
    ...
    \item zwei Unterstützerinnen des Wahlvorschags.
\end{enumerate}

Unterstützerinnen müssen für die betreffende Wahl wahlberechtigt sein. Sie müssen folgende Angaben machen:
\begin{enumerate}
...
\end{enumerate}
Die erste Unterstützerin ist zur Vertretung gegenüber dem Wahlausschuss berechtigt, die zweite Unterstützerin vertritt sie.
...
Mitglieder des Wahlausschusses, des Ältestenrats sowie die Wahlleiterinnen gemäß §~40 Absatz~2 Organisationssatzung und \ref{wahl:wahlleiterinnen} dieser Wahl- und Abstimmungsordnung dürfen weder auf einem Wahlvorschlag als Kandidatin geführt werden noch einen Wahlvorschlag vertreten.
...
Etwaige Mängel am Wahlvorschlag sind der Vertreterin des Wahlvorschlages unverzüglich, spätestens aber am Tag nach Ablauf der Einreichungsfrist mitzuteilen. Danach besteht bis zum Beginn der Wahlausschusssitzung nach \ref{wahl:zulassung:sitzung} die Gelegenheit, die Mängel zu beseitigen. Das Fehlen von erforderlichen Unterschriften gilt nicht als Mangel im oberen Sinne. Diese können nach Ablauf der Einreichungsfrist nicht nachgeholt werden.\label{wahl:wahlvorschlaege:maengel}

\jurparagraph{Zulassung der Wahlvorschläge}\label{wahl:zulassung}
Spätestens am 20.\,Tag vor dem ersten Wahltag beschließt der Wahlausschuss in einer Sitzung über die Zulassung der eingereichten Wahlvorschläge. \label{wahl:zulassung:sitzung}
...
Der Wahlausschuss bestimmt unter den Wahlvorschlägen zum Studierendenparlament per Losziehung eine Reihenfolge.\label{wahl:zulassung:reihenfolge}

\jurparagraph{Bekanntmachung der Wahlvorschläge}\label{wahl:bekanntmachungvorschlaege}
...
\jurparagraph{Briefwahl}\label{wahl:briefwahl}
Eine Wahlberechtigte, die zum Zeitpunkt der Wahl verhindert ist, die Abstimmung vor Ort vorzunehmen, erhält auf Antrag in Schriftform beim Wahlausschuss für die Wahl einen Wahlschein und die Briefwahlunterlagen, bestehend aus einem Stimmzettel für jede Wahl, einem Wahlumschlag und einem Wahlbriefumschlag. Die Ausgabe der Wahlscheine und der Briefwahlunterlagen ist im Wählerinnenverzeichnis zu vermerken.
...
Der Wahlbrief ist an die vorgedruckte Anschrift des Wahlausschusses ausreichend frankiert zu übersenden oder persönlich beim Wahlausschuss abzugeben.

\parnumberfalse
(5a) Der Wahlausschuss kann den Wahlberechtigten die Möglichkeit geben, bei persönlicher Abholung der Briefwahlunterlagen die Briefwahl an Ort und Stelle auszuüben; in diesem Fall kann der Antrag auf Briefwahl auch noch nach Ablauf der Frist nach \ref{wahl:briefwahl:frist} erfolgen. Dabei ist Sorge zu tragen, dass der Stimmzettel unbeobachtet gekennzeichnet und in den Wahlumschlag gelegt werden kann. Der Wahlausschuss nimmt sodann den Wahlbrief entgegen.
\parnumbertrue
...
Wahlscheine und Wahlumschläge werden gezählt und die Wahlscheine mit den Eintragungen im Wählerinnenverzeichnis verglichen. Wurde von der Wählerin eine Stimmabgabe an der Urne vorgenommen, so ist ihr Wahlumschlag ungeöffnet zu vernichten.
...
\jurparagraph{Stimmzettel}\label{wahl:stimmzettel}

Der Stimmzettel enthält:
\begin{enumerate}
    \item die zugelassenen Wahlvorschläge mit ihrem Kennwort und den Kandidatinnen mit Vor- und Nachname und Studiengang; bei den Wahlen zu den Fachschaftsvorständen kann auf die Angabe des Studiengangs verzichtet werden. Die Reihenfolge der Wahlvorschläge auf dem Stimmzettel entspricht der Reihenfolge gemäß \ref{wahl:zulassung:reihenfolge}.
...
\jurparagraph{Wahlurnen und Urnenbuch}\label{wahl:urnen}
Der Wahlausschuss legt die Anzahl der Wahlurnen fest, versiegelt die Urnen und kennzeichnet sie eindeutig und deutlich sichtbar.
...
\begin{enumerate}
    ...
    \item für jede Wählerin den Namen, die Matrikelnummer und die Wahlen, an denen sie teilgenommen hat.
\end{enumerate}

Die Urnen dürfen das Gelände des KIT nicht verlassen; Ausnahmen regelt der Wahlausschuss.

Urnen sind frühestens um 7:00~Uhr zu öffnen und spätestens um 20:00~Uhr zu
schließen.

\jurparagraph{Wahlhelferinnen}\label{wahl:wahlhelferinnen}
Der Wahlausschuss bestellt Wahlhelferinnen zur Durchführung der Wahl. Der Wahlausschuss belehrt die Wahlhelferinnen über ihre Pflichten. Der Wahlausschuss kann die Bestellung und Belehrung von Wahlhelferinnen an die Wahlleiterinnen gemäß §~40 Absatz~2 Organisationssatzung delegieren.
...
\jursubparagraph{Wahlleiterinnen}\label{wahl:wahlleiterinnen}
Zusätzlich zu den gemäß §~31 Absatz~4 Nummer~4 Organisationssatzung eingesetzten Wahlleiterinnen kann der Wahlausschuss Wahlleiterinnen bestellen.

Wahlleiterinnen sind für ein bestimmtes Wahllokal verantwortlich.

\jurparagraph{Wahlhandlung}\label{wahl:wahlhandlung}
...
Beim Einwurf der Stimmzettel markieren die Wahlhelferinnen im Urnenbuch sowie im Wählerinnenverzeichnis die Wahlen, an denen die Wählerin teilgenommen hat. Die Wählerin bestätigt ihre Stimmabgabe durch Unterschrift im Urnenbuch.
...
\jurparagraph{Ende der Wahl, Auszählung}\label{wahl:auszaehlung}
...
\begin{enumerate}
    ...
    \item die mit Bemerkungen versehen sind, ein auf die Person der Wählenden hinweisendes Merkmal oder einen Vorbehalt enthalten,
    \item aus dem sich der Wille der Wählerin nicht zweifelsfrei ergibt,
    \item deren Stimmverteilung nicht den Vorgaben gemäß \ref{wahl:wahlsystem} entspricht; werden bei der Wahl zum Studierendenparlament zu viele Listenstimmen abgegeben, so wird nur die Listenstimme ungültig. Die Gültigkeit der Personenstimmen bleibt unberührt. Gleiches gilt analog bei Abgabe von zu vielen Personenstimmen.
\end{enumerate}
...
\jurparagraph{Verteilung der Sitze und Mandate bei der Wahl zum Studierendenparlament}\label{wahl:sitzverteilungstupa}
...
\jurparagraph{Besetzung der Fachschaftsvorstände}\label{wahl:fsvorstaende}
...
\jurparagraph{Feststellung des Wahlergebnisses, Wahlniederschrift}\label{wahl:wahlniederschrift}
...
\jurparagraph{Bekanntmachung des Wahlergebnisses}\label{wahl:ergebnis}
Nach der Feststellung gibt der Wahlausschuss das Wahlergebnis bekannt. Die Bekanntmachung enthält:
\begin{enumerate}
    \item für jede Wahl die Zahl der Wahlberechtigten,
    \item für jede Wahl die Zahl der Wählerinnen,
