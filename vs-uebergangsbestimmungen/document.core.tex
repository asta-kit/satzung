...
\jurparagraph{Dauer der ersten Amtsperiode}\label{amtsperiode}
...
\jurparagraph{Anzahl der Fachschaftssprecherinnen}\label{fachschaftssprecher}
...
\jurparagraph{Für die erste Besetzung der Organe erforderliche Wahlen}\label{wahlen}
...
\jurparagraph{Konstituierung der Organe}\label{konstituierung}
...
\jurparagraph{Erlass weiterer Satzungen}
